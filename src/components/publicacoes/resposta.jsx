...
const RespostaFeed = ({ publicacao }) => {
  ...
  return (
    <>
      <>
        {/* <div className="codigoidentificacao"> resposta Resposta teste</div> */}
        <>
          ...
          <div className="container-publicacao">
            <div className="detalhes-pub">
              <div>
                <img
                  ...
                  src={publicacao.respostasByIdPublicacao[0].fotoUsuario}
                  alt={publicacao.nome}
                />
              </div>
              <div className="categoria-informacao">
                <div className="conteudo-titulo">
                  ...
                  <div className="dados-frase-resposta">
                    {/* <p className="data">{publicacao.data.toString()}</p> */}
                    <div className="data">
                      <span> {date2} </span>
                    </div>
                  </div>
                ...
                <div>
                  <span className="categoria-tag-duvida">
                    {" "}
                    {tipodepublicacao}{" "}
                  </span>
                </div>
            ...
            <br/>
              <span className="categoria-tag-duvida2">  {publicacao.categoria} </span>
              <br/>
